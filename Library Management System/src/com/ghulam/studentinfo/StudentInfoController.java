...
public class StudentInfoController implements Initializable {
    ...
    private boolean isEmptyFields() {
        if (txtSID.getText().isEmpty()) return false;
        if (txtStudentName.getText().isEmpty()) return false;
        if (txtClass.getSelectionModel().getSelectedItem().toString().isEmpty()) return false;
        if (txtRoll.getText().isEmpty()) return false;
        if (txtMobile.getText().isEmpty()) return false;
        if (txtAddress.getText().isEmpty()) return false;
        return true;
    }
    @FXML
