...
public class MenuController implements Initializable {
    private final static Image DASHBOARD_BLACK = new Image(Main.class.getResource("images/dashboard_black.png").toString());
    private final static Image DASHBOARD_WHITE = new Image(Main.class.getResource("images/dashboard_white.png").toString());
    private final static Image ISSUE_RETURN_BALCK=new Image(Main.class.getResource("images/return_issueBook_balck.png").toString());
    private final static Image ISSUE_RETURN_WHITE=new Image(Main.class.getResource("images/return_issueBook_white.png").toString());
    private final static Image STUDENTINFO_BLACK = new Image(Main.class.getResource("images/students_black.png").toString());
    private final static Image STUDENTINFO_WHITE = new Image(Main.class.getResource("images/students_white.png").toString());
    ...
    private void selectMenu(String fxmlName, ActionEvent event,String controllerClass) {
        ...
        centerPane.setTopAnchor(root, 0.0);
        centerPane.setRightAnchor(root, 0.0);
        centerPane.setBottomAnchor(root, 0.0);
        centerPane.setLeftAnchor(root, 0.0);
    }
